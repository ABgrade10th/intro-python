...
# 1. In your own words, what is a computer program?  A specific set of ordered operations for a computer to perform.

# 2. Name three (3) data types  Floating Point, Character, Enumerated type

# 3. Name three (3) python Operators  i need help on this one
